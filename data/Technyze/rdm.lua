...
-- If hotbar resets/duplicates or freaks out when switching characters. When you get back to main character. Type //lua unload xivhotbar3 and then //lua reload xihotbar
